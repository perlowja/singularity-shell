...
namespace Singularity {
    ...
    public class SystemMonitor : Object {
         ...
         * serves both kernels.
         *
         * NOTE: this build pins libsingularity at 7196e59 ("Add adaptive night
         * light scheduling"), which post-dates the aa7980b commit the original
         * sensors work was developed against. The aa7980b commit added a
         * Severity enum, a ClockReading class, a heat_fraction on every
         * SensorReading, and a richer SensorKind (NPU/VPU/MEMORY/STORAGE/
         * NETWORK/BOARD in addition to CPU/GPU/SYSTEM). Upstream rewrote that
         * history: aa7980b is "remote error: upload-pack: not our ref" and the
         * surviving 7196e59 does not have any of those types. The panel adapts
