        ...
        private static void scan_wallpaper_dir(string path,
            ...
            try {
                ...
                while ((info = enumerator.next_file(null)) != null) {
                    ...
                    int width = 0;
                    int height = 0;
                    // Read only the loader's image header while the directory is
                    // already being scanned. Selection can then regard dimensions
                    // without decoding every candidate on each rotation.
