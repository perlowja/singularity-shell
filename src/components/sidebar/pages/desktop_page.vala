...
namespace Singularity {
    ...
    public class DesktopPage : SettingsPage {
        ...
        public DesktopPage(SettingsView view) {
            ...
            var wallpaper_effect_row = new SelectionRow.with_options(_("Wallpaper Effect"), wallpaper_effect_options, current_effect);
            ...
            blur_row.selected.connect((id) => { int radius; if (int.try_parse(id, out radius)) settings.set_int("wallpaper-effect-blur-radius", radius); });
            ...
            quote_row.entry_changed.connect(() => settings.set_string("wallpaper-effect-quote-text", quote_row.text));
